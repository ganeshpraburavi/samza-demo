...
val samzaRocksDB = "org.apache.samza" % "samza-kv-rocksdb_2.10" % samzaVersion
...
lazy val root =
  Project(
    ...
    settings = packAutoSettings ++
      ...
      Seq(
        libraryDependencies ++= Seq(samzaCore, samzaYarn, samzaKafka, kafka, samzaLog4j, slf4jLog4j12, samzaRocksDB, samzaKV),
        publish := {},
        packResourceDir ++= Map(
